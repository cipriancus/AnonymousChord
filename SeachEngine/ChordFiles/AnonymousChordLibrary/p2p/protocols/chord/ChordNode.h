...
public:
    ...
    virtual string sendRequestTimeout(Request *request, Node* destination, int timeout) ;
    ...
    std::vector<Node*> getFingerTable() {
        return fingerTable;
    }
    ...
    void addHandledQuery(Query *query) {
        this->handledQueries.push_back(query);
    }
